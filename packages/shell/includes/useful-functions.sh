...
#
#
#  FUNCTIONS THAT CAN BE INCLUDED IN SCRIPTS - https://goo.gl/Z5Ri8A
#
#
#
# _          _
...
# Usage:
#   _contains <item> <list>
# e.g. if _contains "${opt}" "${_SUBCOMMAND_PROGRAM_LIST}"
#	then
#    ...
#	fi
#
# Creating the list e.g. VAR_NAME='psql drop schema-create'
#
# Example:
#   _contains "$item" "${list[*]}"
#
...
#
# Usage:
#   _list_intersect <arr1> <arr2>
#
# 
#
# Example:
#   _list_intersect 'carrot apple' 'apple banana carrot' = carrot \n apple
#
# Returns:
#   Bash array
_list_intersect() {
  # - https://stackoverflow.com/a/28161520/2968327
  # debug "echo "${1}" "${2}" | tr ' ' '\n' | sort | uniq -d"
  echo "${1}" "${2}" | tr ' ' '\n' | sort | uniq -d
}
###############################################################################
...
#
# Usage:
#   _list_diff <arr1> <arr2>
#
# 
#
# Example:
#   _list_diff 'carrot apple' 'blackberry melon' = carrot \n apple
#
# Returns:
#   Bash array
_list_diff() {
  # - https://stackoverflow.com/a/28161520/2968327
  local _DIFF_ALL=$(echo "${1}" "${2}" | tr ' ' '\n' | sort | uniq -u | tr '\n' ' ')
  # debug "_list_intersect "${1}" "${_DIFF_ALL}""
  _list_intersect "${1}" "${_DIFF_ALL}"
}
