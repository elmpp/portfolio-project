import {FeedSupplierName as FeedSupplierEnum} from '../../../../../partridge-config/src/__types__/config'
...
export type EventByCanonicalisedNameUniqueQueryVariables = {
  canonicalisedNameUnique: Scalars['String']
}

export type EventByCanonicalisedNameUniqueQuery = {__typename?: 'Query'} & {
  eventByCanonicalisedNameUniqueQuery: Maybe<
    {__typename?: 'EventView'} & Pick<
      EventView,
      | 'canonicalisedName'
      ...
      | 'url'
    > & {
        markets: {__typename?: 'MarketViewsConnection'} & {
          pageInfo: {__typename?: 'PageInfo'} & Pick<PageInfo, 'hasNextPage'>
          nodes: Array<
            Maybe<
              {__typename?: 'MarketView'} & Pick<
                MarketView,
                | 'cashoutAvailable'
                | 'eachwayAvailable'
                | 'firstFourAvailable'
                ...
                | 'canonicalisedName'
              > & {
                  outcomes: {__typename?: 'OutcomeViewsConnection'} & {
                    nodes: Array<Maybe<{__typename?: 'OutcomeView'} & OutcomeFragmentFragment>>
                  }
                }
            >
          >
...
export type OutcomeFragmentFragment = {__typename?: 'OutcomeView'} & Pick<
  OutcomeView,
  | 'id'
  | 'odds'
  | 'oddsDecimal'
...
export type DimensionsMutationMutationVariables = {
  dimensionsInput: DimensionsInput
}

export type DimensionsMutationMutation = {__typename?: 'Mutation'} & {
  updateDimensions: Maybe<
    {__typename?: 'Dimensions'} & Pick<Dimensions, 'width' | 'height' | 'scale' | 'fontScale' | 'orientation'> & {
        lessThan: {__typename?: 'DimensionsSet'} & Pick<DimensionsSet, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl'>
        greaterThan: {__typename?: 'DimensionsSet'} & Pick<DimensionsSet, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl'>
        is: {__typename?: 'DimensionsSet'} & Pick<DimensionsSet, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl'>
      }
  >
}

export type DimensionsQueryQueryVariables = {}

export type DimensionsQueryQuery = {__typename?: 'Query'} & {
  dimensions: {__typename?: 'Dimensions'} & Pick<
    Dimensions,
    'width' | 'height' | 'scale' | 'fontScale' | 'orientation'
  > & {
      lessThan: {__typename?: 'DimensionsSet'} & Pick<DimensionsSet, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl'>
      greaterThan: {__typename?: 'DimensionsSet'} & Pick<DimensionsSet, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl'>
      is: {__typename?: 'DimensionsSet'} & Pick<DimensionsSet, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl'>
...
export type SettingsQueryQueryVariables = {}

export type SettingsQueryQuery = {__typename?: 'Query'} & {
  settings: {__typename?: 'Settings'} & Pick<Settings, 'layoutSize'>
}
