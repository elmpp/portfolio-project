/**
 * Fairly hacky method of augmenting the react-native typings to include react-native-web
 * @see package.json:postinstall
 *
 *  - from here - https://tinyurl.com/y35v9urx
 *  - discussion - https://tinyurl.com/yxrkhnwz
 *  - react-native types (v0.57.0) - https://tinyurl.com/y35zwse5
 *  - react-native-web source - https://tinyurl.com/yy5x7mqc
 */
...
fs.writeFile(`${RN_TSD}`, raw.toString().replace('declare global', 'declare namespace RemovedGlobals'), {}, () => {
  ...
  if (!raw.includes('REACT-NATIVE-WEB TYPINGS')) {
    ...
    fs.writeFileSync(
      ...
      ///////////////// Altered by MP //////////////
      /**
       * RNW src - https://tinyurl.com/yxasgcfo
       */
      ...
      export namespace AppRegistry {
        function getApplication(appKey: string, appParameters?: object): Application;
      }
  `
      )
    )
