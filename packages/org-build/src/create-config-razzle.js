...
module.exports = (
  ...
  const clientPublicPath =
    dotenv.raw.CLIENT_PUBLIC_PATH || (IS_DEV ? `http://${dotenv.raw.HOST}:${devServerPort}/` : '/')
  ...
  if (IS_WEB) {
    ...
    if (IS_DEV) {
      ...
      config.entry = {
        client: [require.resolve('razzle-dev-utils/webpackHotDevClient'), paths.appClientIndexJs],
      }
