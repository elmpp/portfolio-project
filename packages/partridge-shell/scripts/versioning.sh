...
_SUBCOMMAND_PROGRAM_LIST='subtree-sync subtree-sync-all feature-branch-start feature-branch-finish feature-branch-abort release-branch-start release-branch-finish release-branch-abort release-branch-abort-local changelog release-branch-prerelease-build build-and-commit'
_VERSION=1.2.0
